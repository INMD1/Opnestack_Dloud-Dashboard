...
export default function TermsofUseClient({ Getyears }: TermsofUseClientProps) {
  ...
  React.useEffect(() => {
    const fetchContent = async () => {
      setLoading(true)
      const res = await fetch(`/api/markdown?year=${value}`)
  ...
  return (
    <div>
      <div className="min-h-screen flex flex-col items-start p-20 bg-[#17171c]">
        <p className="text-3xl mb-6 text-white font-bold">서비스 이용약관</p>
